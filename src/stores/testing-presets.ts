...
export const DEFAULT_TEST_TASKS: TestTask[] = [
  {
    ...
    userPrompt: "请仔细阅读当前目录下的 skills.md 和 workspace_instructions.md，理解所有目录与安全限制，确认当前沙箱工作空间环境可用，并将自检状态记录到 test_log.json 中。",
    status: "idle",
  },
  {
    id: "task-reasoning",
    ...
    userPrompt: "请一步步深度分析当前工作目录 skills.md 中的拦截规则：如何保证所有命令仅在本地执行？如何验证外部网络请求被100%拦截？请详细输出推导过程与证明。",
    status: "idle",
  },
  {
    id: "task-tools",
  ...
  },
  {
    ...
    category: "speed",
    userPrompt: "请在当前工作空间内进行一次基准测试：测量使用本地命令创建 3 个小文本文件并读取它们的总耗时，将测速指标写入 test_results/speed_test.txt 并总结。",
    status: "idle",
  },
];
