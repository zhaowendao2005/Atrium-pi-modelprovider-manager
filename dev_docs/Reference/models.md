...
[Home](https://pi.dev/)[Documentation](https://pi.dev/docs/latest)[News](https://pi.dev/news)[Packages](https://pi.dev/packages)[Models](https://pi.dev/models)
...
[Table of Contents](https://pi.dev/docs/latest/models#table-of-contents)[Minimal Example](https://pi.dev/docs/latest/models#minimal-example)[Full Example](https://pi.dev/docs/latest/models#full-example)[Google AI Studio Example](https://pi.dev/docs/latest/models#google-ai-studio-example)[Supported APIs](https://pi.dev/docs/latest/models#supported-apis)[Provider Configuration](https://pi.dev/docs/latest/models#provider-configuration)[Value Resolution](https://pi.dev/docs/latest/models#value-resolution)[Custom Headers](https://pi.dev/docs/latest/models#custom-headers)[Model Configuration](https://pi.dev/docs/latest/models#model-configuration)[Sampling Parameters](https://pi.dev/docs/latest/models#sampling-parameters)[Thinking Level Map](https://pi.dev/docs/latest/models#thinking-level-map)[Overriding Built-in Providers](https://pi.dev/docs/latest/models#overriding-built-in-providers)[Per-model Overrides](https://pi.dev/docs/latest/models#per-model-overrides)[Anthropic Messages Compatibility](https://pi.dev/docs/latest/models#anthropic-messages-compatibility)[OpenAI Compatibility](https://pi.dev/docs/latest/models#openai-compatibility)

Documentation

## Start here

[Overview](https://pi.dev/docs/latest)[Quickstart](https://pi.dev/docs/latest/quickstart)[Using Pi](https://pi.dev/docs/latest/usage)[Providers](https://pi.dev/docs/latest/providers)[Security](https://pi.dev/docs/latest/security)[Containerization](https://pi.dev/docs/latest/containerization)[Settings](https://pi.dev/docs/latest/settings)[Keybindings](https://pi.dev/docs/latest/keybindings)[Sessions](https://pi.dev/docs/latest/sessions)[Compaction](https://pi.dev/docs/latest/compaction)
...
Latest·[](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/models.md)·[](https://github.com/earendil-works/pi/edit/main/packages/coding-agent/docs/models.md)

Add custom providers and models (Ollama, vLLM, LM Studio, proxies) via `~/.pi/agent/models.json`.

## Table of Contents

[Copied](https://pi.dev/docs/latest/models#table-of-contents)
...
[Copied](https://pi.dev/docs/latest/models#minimal-example)
...
[Copied](https://pi.dev/docs/latest/models#full-example)
...
[Copied](https://pi.dev/docs/latest/models#google-ai-studio-example)
...
[Copied](https://pi.dev/docs/latest/models#supported-apis)
...
[Copied](https://pi.dev/docs/latest/models#provider-configuration)
...
[Copied](https://pi.dev/docs/latest/models#value-resolution)
...
[Copied](https://pi.dev/docs/latest/models#custom-headers)
...
[Copied](https://pi.dev/docs/latest/models#model-configuration)
...
[Copied](https://pi.dev/docs/latest/models#sampling-parameters)
...
[Copied](https://pi.dev/docs/latest/models#thinking-level-map)
...
[Copied](https://pi.dev/docs/latest/models#overriding-built-in-providers)
...
[Copied](https://pi.dev/docs/latest/models#per-model-overrides)
...
[Copied](https://pi.dev/docs/latest/models#anthropic-messages-compatibility)
...
[Copied](https://pi.dev/docs/latest/models#openai-compatibility)
